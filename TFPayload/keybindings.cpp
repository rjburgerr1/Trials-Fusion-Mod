...
void Keybindings::Initialize() {
    ...
    s_keybindings[Action::ReloadObjectCollection] = VK_F12;  // F12 key
    ...
    s_keyStates[Action::ReloadObjectCollection] = false;
...
std::string Keybindings::GetActionName(Action action) {
    switch (action) {
        ...
        case Action::ReloadObjectCollection:
            return "Reload Object Collection";
        default:
...
bool Keybindings::LoadFromFile() {
    ...
    while (std::getline(file, line)) {
        ...
        try {
            ...
            } else if (actionName == "Reload Object Collection") {
                s_keybindings[Action::ReloadObjectCollection] = vkCode;
            }
